            ...
            <div className="container ">
                <div className="py-4 lg:py-14">
                    ...
                    <p className="text-2xl font-medium lg:w-1/2">
                        The KS INFRASTRUCTURE interior design company is a company that provides interior design services for homes, offices, apartments, and others. We provide the best interior design services for you. We have a team that is experienced in the field of interior.
                    </p>
                </div>
                    ...
                    <div className="grid gap-20 py-8 lg:grid-cols-3">
                        ...
                        <div className="border-2 border-gray-500 ">
                            <div className="-m-0.5 p-4 text-center transition hover:-translate-y-3 hover:-translate-x-3 aspect-square bg-zinc-100 ">
                                ...
                                <h2 className="py-4 text-2xl font-semibold " >Manish solanki(CEO)</h2>
